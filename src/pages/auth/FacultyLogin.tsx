...
const FacultyLogin = () => {
  ...
  const validateFacultyEmail = (email: string) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Validate if the user is a faculty member based on email
    if (!validateFacultyEmail(loginData.email)) {
      toast.error('You are not a faculty member. Faculty emails must contain .com');
      setIsLoading(false);
      return;
    }
    
    try {
      const success = await login(loginData.email, loginData.password, 'faculty');
  ...
  return (
    <PageTransition>
      <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative">
        <div 
          className="absolute inset-0 -z-10 bg-[radial-gradient(45%_25%_at_50%_50%,rgba(30,64,175,0.05),transparent)]"
          aria-hidden="true"
        />
        ...
        <div className="w-full max-w-md">
          <div className="text-center mb-8 animate-fade-in-down">
            ...
            <p className="text-muted-foreground mt-2">
              Access your faculty account to manage resources
            </p>
          </div>
          ...
          <CardCustom variant="default" className="animate-fade-in">
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="professor@faculty.com"
                    />
                  </div>
                  <p className="text-xs text-muted-foreground mt-1">
                    Faculty email must contain .com
                  </p>
                </div>
            ...
            <CardFooter className="flex flex-col space-y-4">
              <div className="text-center text-sm">
                <span className="text-muted-foreground">Need faculty account approval? </span>
              ...
              <div className="text-center text-sm">
                ...
                <Link className="font-medium text-primary hover:text-primary/80" to="/auth/student-login">
                  Student login
                </Link>
              </div>
            </CardFooter>
